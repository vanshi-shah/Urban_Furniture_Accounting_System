...
*   **Frontend:** Scaffold React app with a design system (e.g., Tailwind/shadcn). Build Login/Register screens. Setup routing & global state for Auth.
*   **Micro-Changes:**
    *   *Frontend:* Auto-redirect to dashboard on login.
